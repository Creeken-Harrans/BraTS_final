...
class BratsTrainer:
    def __init__(
        ...
        *,
        ...
        self.metadata_dir = get_primary_preprocessed_dataset_dir()
        ...
        self.dataset_json = json.loads((self.metadata_dir / "dataset.json").read_text(encoding="utf-8"))
        self.splits = json.loads((self.metadata_dir / "splits_final.json").read_text(encoding="utf-8"))
